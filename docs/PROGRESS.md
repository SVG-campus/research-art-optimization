...
| Reproducibility | 78 | `runs/smoke.yaml`, `runs/ci_notebooks.yaml`, `methodology_preamble`, pytest + headless CI (six CI notebooks (adds `CHARTER_FASHION_MNIST_STREAM_SMOKE` on Fashion-MNIST stream)) |
