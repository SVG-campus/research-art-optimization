...
**`notebooks/CHARTER_FASHION_MNIST_STREAM_SMOKE.ipynb`** runs next: small streaming slice of `zalando-datasets/fashion_mnist` + y-shuffle null + run card (CV tensor smoke only).
